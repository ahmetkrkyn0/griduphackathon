...
| Sistemin tespit oranı (rapor `docs/12`'den) | %70 (etiketli senaryo setinde ölçülecek) |
| Pano başına yıllık beklenen önlenen kayıp | 0,03 × 8.000 × 0,70 ≈ **168 USD/pano/yıl** |

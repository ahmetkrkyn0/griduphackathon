...
| Operasyon arayüzü | Kontrol odası | React arayüzü (9 ekranın 7'si) | **Gerçek** | `frontend/` **154 test** (17 dosya; 5'i bileşen/DOM testi), `docs/16`; 7 ekran **canlı API'de 0 konsol hatası — ölçümü artık `frontend/e2e/smoke.spec.ts` yeniden üretiyor** | C · ✅ |
...
| Backend (B) | `cd backend && pytest` | **880 geçti / 37 atlandı** (19 Eylül, `TEST_DB_DSN` **verilmeden**; toplanan 917). **DSN'li sayı bu oturumda yeniden ölçülmedi** — tohumlayıcı münhasır veritabanı ister, canlı yığın ayaktaydı (bkz. `README.md` Testler bölümü) |
| Frontend (C) | `npm ci && npm test && npm run build` | **154 / 154** (17 dosya, vitest 2.1.9), `tsc --noEmit` **0 hata** (19 Eylül) |

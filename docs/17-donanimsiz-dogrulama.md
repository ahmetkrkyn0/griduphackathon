...
| Operasyon arayüzü | Kontrol odası | React arayüzü (9 ekranın 7'si) | **Gerçek** | `frontend/` **162 test** (19 dosya; 4'ü bileşen/DOM testi), `docs/16`; 7 ekran **canlı API'de 0 konsol hatası — ölçümü artık `frontend/e2e/smoke.spec.ts` yeniden üretiyor** | C · ✅ |
...
| Frontend (C) | `npm ci && npm test && npm run build` | **162 / 162** (19 dosya, vitest 2.1.9), `tsc --noEmit` **0 hata** (20 Eylül) |

...
```bash
# Algoritma ve fizik motoru testleri — 498 test, 0 atlanan
cd libs/panoalgo && pytest

# Backend, veritabanı, SCADA, bildirim ve Telegram testleri — 880 geçer / 37 atlanır (917 toplanır)
cd backend && pytest

# Frontend birim + bileşen testleri ve TypeScript tip doğrulaması — 154 test, 0 hata
...
TEST_DB_DSN="postgresql://postgres:gridup@127.0.0.1:5432/gridup" pytest   # backend/ içinde → 917 test toplanır

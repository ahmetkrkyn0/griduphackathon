...
| 4 | TVOC-2 bir **SIL-2 koruma cihazıdır**; ışıktan açma kontağına ~1 ms (katalog), arkın sönmesi kesicinin açma süresine bağlıdır. | Bizim değerimiz arkı "tespit etmek" değil: **koruma sisteminin sağlığını izlemek** (sensör arızası = sessizce korumasız pano), olayı konumla bildirmek ve **ark öncesi öncüleri** yakalamak. Koruma devresine **yazma yapılmamalı**. |
...
| **ABB TVOC-2** | Optik ark tespiti, ışık→açma kontağı ~1 ms | SIL-2, kanıtlanmış | Koruma cihazı; öngörü/trend yok |
